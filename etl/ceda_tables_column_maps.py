...
# DBTITLE 1,Patient table column map
...
# DBTITLE 1,Patient race table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Encounter table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Encounter admission reason table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Encounter chief complaint table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Encounter diagnosis table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Problem list table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Diagnosis table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Procedure order table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Lab result table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Medication order table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Medication administration table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Flowsheet table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Flowsheet entry table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Flowsheet definition table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Inpatient data table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery summary table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block OB history table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block link table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block labor and delivery information table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block ob delivery signed by table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block analgesic table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block anesthesia method table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery breech type table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery cord blood disposition table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery cord complications table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery cord vessels table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery forceps location table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery gases sent table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery living status table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery presentation type table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery resuscitation type table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block delivery vacuum location table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block placenta appearance table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
...
# DBTITLE 1,Summary block placenta removal table column map
# Specify CEDA table column names and what ReDaP column(s) they correspond to
# If multiple columns are specified, then concatenate columns
