...
# MAGIC %md
# MAGIC Cohort utility functions (Use \_\_doc\_\_ property of any function to get usage details):
# MAGIC - get_infectious_disease_cohort
# MAGIC - get_maternity_cohort

# COMMAND ----------

# DBTITLE 1,Get infectious disease cohort
...
# DBTITLE 1,Maternity cohort columns map
...
# DBTITLE 1,Get maternity cohort
