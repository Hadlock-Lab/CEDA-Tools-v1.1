...
# DBTITLE 1,Load CEDA table column maps
# MAGIC %run
# MAGIC "./ceda_tables_column_maps"

# COMMAND ----------

# DBTITLE 1,Get patient table
...
# DBTITLE 1,Get problem list table
...
# DBTITLE 1,Get procedure order table
...
# DBTITLE 1,Get medication order table
...
# DBTITLE 1,Get summary block table
