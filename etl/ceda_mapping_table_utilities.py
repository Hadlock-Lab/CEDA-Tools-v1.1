...
# DBTITLE 1,Get Diagnosis ID / SNOMED mapping
...
# DBTITLE 1,Get SNOMED / Diagnosis ID map and counts
...
# DBTITLE 1,Get Medication ID / RxNorm mapping
...
# DBTITLE 1,Get RxNorm / Medication ID map and counts
...
# DBTITLE 1,Get Lab ID / LOINC mapping
...
# DBTITLE 1,Get LOINC / Lab ID map and counts
